...
class AppModule {
    ...
    ngDoBootstrap() {
        ...
        const registerFormComponent = Object(_angular_elements__WEBPACK_IMPORTED_MODULE_2__["createCustomElement"])(_register_form_register_form_component__WEBPACK_IMPORTED_MODULE_3__["RegisterFormComponent"], { injector: this.injector });
        customElements.define('register-form', registerFormComponent);
        const loginFormComponent = Object(_angular_elements__WEBPACK_IMPORTED_MODULE_2__["createCustomElement"])(_login_form_login_form_component__WEBPACK_IMPORTED_MODULE_4__["LoginFormComponent"], { injector: this.injector });
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, { declarations: [
        // AppComponent,
        _register_form_register_form_component__WEBPACK_IMPORTED_MODULE_3__["RegisterFormComponent"],
...
LoginFormComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LoginFormComponent, selectors: [["app-login-form"]], inputs: { buttonlabel: "buttonlabel" }, features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵNgOnChangesFeature"]], decls: 15, vars: 1, consts: [[1, "container"], ["action", ""], ["for", "username"], ["type", "text", "id", "username", "placeholder", "Email / Username"], ["for", "password"], ["type", "text", "id", "password", "placeholder", "Password"]], template: function LoginFormComponent_Template(rf, ctx) { if (rf & 1) {
...
RegisterFormComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: RegisterFormComponent, selectors: [["app-register-form"]], inputs: { buttonlabel: "buttonlabel" }, features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵNgOnChangesFeature"]], decls: 23, vars: 1, consts: [[1, "container"], ["action", ""], ["for", "username"], ["type", "text", "id", "username", "placeholder", "Email / Username"], ["for", "password"], ["type", "text", "id", "password", "placeholder", "Password"], ["for", "name"], ["type", "text", "id", "name", "placeholder", "Name"], ["for", "dob"], ["type", "calendar", "id", "dob", "placeholder", "Date of birth"]], template: function RegisterFormComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "p");
...
module.exports = __webpack_require__(/*! /Users/ashish.kumar/Documents/dev/learnings/angular/web-components-with-angular/src/main.ts */"./src/main.ts");
